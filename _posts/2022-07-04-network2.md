---
layout : single
title : "CCNA 강의 2 : OSI 7 Layers (3~1계층)"
categories: Security
tag: [network]
sidebar:
    nav: "docs"
 ...
 *MAC 주소의 구조*<br><br>
  ...
  *CSMA : 각 노드들이 프레임을 전송하기 위해 공유 매체에 접근하기 전에, 먼저 매체의 통신 상황을 감지하여, 케이블이 열리면 송신하는 다중 접속 프로토콜<br><br>
  ...
  - 1계층 : Physical Layer (물리 계층)<br><br>
  2계층의 프레임을 받은 후 다음 장치에 구리 / 광섬유 또는 무선 통신 매체를 전송하기 위한 신호(전기 신호 : 0 off, 1 on)로 변경한다. 변경된 신호들은 수신측에서 기존의 형태로 바뀌어 2계층으로 전달된다.  <br><br>
